"""
Resizer module for ILVR down/upsampling operations.
Source: https://github.com/assafshocher/resizer
"""
...
class Resizer(nn.Module):
    """High-quality image resizing with anti-aliasing for ILVR."""
    ...
    def __init__(self, in_shape, scale_factor=None, output_shape=None, kernel=None, antialiasing=True):
        ...
        for dim in self.sorted_dims:
            ...
            weights_list.append(
                nn.Parameter(torch.reshape(weights, list(weights.shape) + (len(scale_factor) - 1) * [1]), requires_grad=False))
